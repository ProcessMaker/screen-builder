describe('Nested screen', () => {
  it('With a variable defined', () => {
    ...
    cy.get('[data-cy=inspector-DataVariable]').type('person');
    cy.get('[data-cy=inspector-SelectScreen] div.multiselect').click();
    cy.get('[data-cy=inspector-SelectScreen] span:contains("Sub screen example"):first').click();
