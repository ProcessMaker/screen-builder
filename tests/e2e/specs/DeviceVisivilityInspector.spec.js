...
describe('Device Visiblility Inspector', () => {
  ...
  it('Verify Device Visibility of controls inside a loop', () => {
    ...
    cy.get('[data-cy="inspector-deviceVisibility"]>* div:nth-child(2) > label').click();
    ...
    cy.get('body')
      .then($body => {
        let lineinputControlls = $body.find('[name="form_input_1"]').length;
  ...
  it('Verify Device Visibility of controls inside a Record List', () => {
    ...
    let filePath = 'recordListDeviceVisibility.json';
    ...
    cy.get('[data-cy="modal-add"]>* footer>button:nth-child(1)').should('be.visible');
  ...
  it('Verify Device Visibility of controls inside a table', () => {
    ...
    //Step 6: Verify that line input is not visible in Web
    previewScreenWebMobile('desktop');
    cy.get('[data-cy="screen-field-form_text_area_1"]').should('not.be.visible');
  ...
  it('Verify Device Visibility of controls inside a table mobile', () => {
    ...
    //Step 4: Disable for Show for desktop
    cy.get('[data-cy="inspector-deviceVisibility"]>* div:nth-child(3) > label').click();
  ...
  it('Verify Device Visibility with dynamic variable', () => {
    ...
    //Step 1: Upload the screen Record List
    let filePath = 'deviceVisibilityDynamic.json';
    cy.loadFromJson(filePath, 0);
    ...
    cy.get('[data-cy="screen-field-form_checkbox_1"]').click().should('be.visible');
    ...
    cy.get('[data-cy="screen-field-form_input_1"]').click().should('be.visible');
    cy.get('[name="loop_1"]>* p').click().should('be.visible');
    cy.get('button[aria-label="Page Navigation"]').click().should('be.visible');
    cy.get('[data-cy="screen-field-form_select_list_1"]').click().should('be.visible');
    cy.get('[data-cy="screen-field-form_text_area_1"]').click().should('be.visible');
