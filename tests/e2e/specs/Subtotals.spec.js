describe("Subtotals implementations", () => {
  ...
  it("Simple using calculated properties and defualt values", () => {
    ...
    cy.get("[data-cy=preview-content] [name=subtotal]")
      .eq(0)
      .should("have.value", "369");
  ...
  it("Using calculated fields", () => {
    ...
    cy.get("[data-cy=preview-content] [name=total_line]").should(
      "have.value",
      "$ 369.00 USD"
    );
    ...
    cy.get("[data-cy=preview-content] [name=total_line_1]").should(
      "have.value",
      "$ 12.00 USD"
    );
  ...
  it("Using calculated fields 2", () => {
    ...
    cy.get("[data-cy=preview-content] [name=subtotal_1]").should(
      "have.value",
      "$ 12.00 USD"
    );
    ...
    cy.get("[data-cy=preview-content] [name=subtotal_2]").should(
      "have.value",
      "$ 369.00 USD"
    );
    ...
    cy.get("[data-cy=preview-content] [name=subtotal_3]").should(
      "have.value",
      "$ 24.00 USD"
    );
