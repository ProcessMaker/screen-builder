...
describe("Computed fields", () => {
  ...
  it("The user should not be able to change a FormTextArea assigned to a computed property", () => {
    ...
    cy.get('[data-cy="calcs-property-description"]')
      .clear()
      .type("form_text_area_1 is always 1");
    cy.get('[data-cy="calcs-switch-javascript"]').click();
    cy.setVueComponentValue(
      '[data-cy="calcs-property-javascript"]',
      'return "1";'
  ...
  it("The user should not be able to change a FormDatePicker assigned to a computed property", () => {
    ...
    cy.get('[data-cy="topbar-calcs"]').click();
    cy.get('[data-cy="calcs-add-property"]').click();
    cy.get('[data-cy="calcs-property-name"]')
      .clear()
      .type("form_date_picker_1");
    cy.get('[data-cy="calcs-property-description"]')
      .clear()
      .type("form_date_picker_1 is always 1");
    cy.get('[data-cy="calcs-switch-javascript"]').click();
    cy.setVueComponentValue(
      '[data-cy="calcs-property-javascript"]',
      'return "1";'
  ...
  it("The user should not be able to change a FormSelectList assigned to a computed property", () => {
    ...
    cy.get('[data-cy="calcs-property-name"]')
      .clear()
      .type("form_select_list_1");
    cy.get('[data-cy="calcs-property-description"]')
      .clear()
      .type("form_select_list_1 is always 1");
    cy.get('[data-cy="calcs-switch-javascript"]').click();
    cy.setVueComponentValue(
      '[data-cy="calcs-property-javascript"]',
      'return "1";'
    ...
    cy.get(
      '[data-cy=preview-content] [data-cy="screen-field-form_select_list_1"] input'
    ).should("have.attr", "disabled");
  ...
  it("The user should not be able to change an input assigned to a sub property of a computed property", () => {
    ...
    cy.get('[data-cy=preview-content] [name="object.foo"]').should(
      "have.attr",
      "readonly"
    );
