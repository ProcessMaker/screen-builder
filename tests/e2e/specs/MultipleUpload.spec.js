describe("Multiple Upload", () => {
  ...
  it("Upload multiple files", () => {
    ...
    cy.get("[data-cy=preview-content] [data-cy=screen-field-filemultiple]").find("[data-cy=2] [title=Delete]").click();
    // The row of file 2 sould not exist, but file 1 should exist
    cy.get("[data-cy=preview-content] [data-cy=screen-field-filemultiple]").find("[data-cy=2] .uploader-file-name").should("not.exist");
    cy.get("[data-cy=preview-content] [data-cy=screen-field-filemultiple]").find("[data-cy=1] .uploader-file-name").should("exist");
    ...
    cy.get("[data-cy=preview-content] [data-cy=screen-field-filemultiple]").find("[data-cy=1] [title=Delete]").click();
    cy.get("[data-cy=preview-content] [data-cy=screen-field-filemultiple]").find("[data-cy=1] .uploader-file-name").should("not.exist");
  });
  ...
  it("Upload files in record lists", () => {
    ...
    cy.get("[data-cy=preview-content] [data-cy=screen-field-pictures]").find("[data-cy=2] [title=Delete]").click();
    // The row of file 2 should not be listed, but file 1 yes
    cy.get("[data-cy=preview-content] [data-cy=screen-field-pictures]").find("[data-cy=2] .uploader-file-name").should("not.exist");
    cy.get("[data-cy=preview-content] [data-cy=screen-field-pictures]").find("[data-cy=1] .uploader-file-name").should("exist");
  });
});
