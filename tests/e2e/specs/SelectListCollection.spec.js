describe("select list mustache", () => {
  ...
  it("Verify Load values in radio list mustache + collection", () => {
    ...
    cy.get('[data-cy="screen-field-form_select_list_2"] + .form-check-label:contains("Oliver")')
      .parent()
      .find("input")
      .should("be.checked");
    cy.get('[data-cy="screen-field-form_select_list_3"] + .form-check-label:contains("DNI: 1234 Name: Oliver Smith")')
      .parent()
      .find("input")
      .should("be.checked");
    cy.get('[data-cy="screen-field-form_select_list_4"] + .form-check-label:contains("Oliver Smith")')
      .parent()
      .find("input")
      .should("be.checked");
    cy.get('[data-cy="screen-field-form_select_list_5"] + .form-check-label:contains("Oliver Smith")')
      .parent()
      .find("input")
      .should("be.checked");
    cy.get('[data-cy="screen-field-form_select_list_6"] + .form-check-label:contains("Oliver Smith")')
      .parent()
      .find("input")
      .should("be.checked");
  ...
  it("Verify Load value in check list mustache + collection", () => {
    ...
    cy.get('[data-cy="screen-field-form_select_list_3"] + .form-check-label:contains("DNI: 1234 Name: Oliver Smith")')
      ...
      .find("input")
      .should("be.checked");
    cy.get('[data-cy="screen-field-form_select_list_3"] + .form-check-label:contains("DNI: 5678 Name: John Doe")')
      .parent()
      .find("input")
      .should("be.checked");
    ...
    cy.get('[data-cy="screen-field-form_select_list_4"] + .form-check-label:contains("Oliver Smith")')
      ...
      .find("input")
      .should("be.checked");
    cy.get('[data-cy="screen-field-form_select_list_4"] + .form-check-label:contains("John Doe")')
      .parent()
      .find("input")
      .should("be.checked");
    ...
    cy.get('[data-cy="screen-field-form_select_list_5"] + .form-check-label:contains("Oliver Smith")')
      ...
      .find("input")
      .should("be.checked");
    cy.get('[data-cy="screen-field-form_select_list_5"] + .form-check-label:contains("John Doe")')
      .parent()
      .find("input")
      .should("be.checked");
    ...
    cy.get('[data-cy="screen-field-form_select_list_6"] + .form-check-label:contains("Oliver Smith")')
      ...
      .find("input")
      .should("be.checked");
    cy.get('[data-cy="screen-field-form_select_list_6"] + .form-check-label:contains("John Doe")')
      .parent()
      .find("input")
      .should("be.checked");
  ...
  it("Verify Load values in multiselect list mustache + collection", () => {
    ...
    cy.get('[data-cy="screen-field-form_select_list_3"] .multiselect__tag:contains("DNI: 1234 Name: Oliver Smith")').contains(
      "DNI: 1234 Name: Oliver Smith"
    );
    cy.get('[data-cy="screen-field-form_select_list_3"] .multiselect__tag:contains("DNI: 5678 Name: John Doe")').contains(
      "DNI: 5678 Name: John Doe"
    );
