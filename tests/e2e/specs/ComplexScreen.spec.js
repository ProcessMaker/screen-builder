...
describe("Complex screen", () => {
  ...
  it("Fill page 1", () => {
    ...
    cy.get("[data-cy=preview-content] [data-cy=screen-field-form_record_list_1] [data-cy=modal-add] [name=first_name]")
      .clear()
      .type("Thomas");
    cy.get("[data-cy=preview-content] [data-cy=screen-field-form_record_list_1] [data-cy=modal-add] [name=last_name]")
      .clear()
      .type("Anderson");
  ...
  it("Fill page 3", () => {
    ...
    cy.get("[data-cy=preview-content] [data-cy=screen-field-form_record_list_2] [data-cy=modal-add] [name=first_name]")
      .eq(loop)
      .clear()
      .type("Thomas");
    cy.get("[data-cy=preview-content] [data-cy=screen-field-form_record_list_2] [data-cy=modal-add] [name=last_name]")
      .eq(loop)
      .clear()
      .type("Anderson");
    ...
    cy.get("[data-cy=preview-content] [data-cy=screen-field-form_record_list_2] [data-cy=modal-edit] [name=first_name]")
      .eq(loop)
      .type(" A.");
    cy.get("[data-cy=preview-content] [data-cy=screen-field-form_record_list_2] [data-cy=modal-edit] button:contains(Save)")
      .eq(loop)
      .click();
  ...
  it("Fill page 4", () => {
    ...
    cy.get("[data-cy=preview-content] [data-cy=screen-field-form_record_list_1] [data-cy=modal-edit] [name=email]")
      .clear()
      .type("thomas@processmaker.com");
    cy.get("[data-cy=preview-content] [data-cy=screen-field-form_record_list_1] [data-cy=modal-edit] [name=url]")
      .clear()
