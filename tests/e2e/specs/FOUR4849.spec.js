describe("Tests null object property bind to an input text", () => {
  ...
  it("Verify visibility rules do not break", () => {
    ...
    cy.get('[data-cy=preview-content] [name="select1.form_input_1"]').should(
      "not.be.visible"
    );
    ...
    cy.get('[data-cy=preview-content] [name="select1.form_input_1"]')
      .clear()
      .type("it works with person=null");

    cy.get(
      '[data-cy=preview-content] [data-cy="screen-field-person"]'
    ).selectOption("1");
    ...
    cy.get('[data-cy=preview-content] [name="select1.form_input_1"]')
      .clear()
      .type("still working with person=1");
    ...
    cy.get('[data-cy=preview-content] [name="select1.form_input_1"]')
      .clear()
      .type("still working with person back to null");
