...
describe("Date Picker", () => {
  ...
  it("Date time picker with maxDate before minDate should show a validation error", () => {
    ...
    cy.get(".invalid-feedback > div").should("be.visible").should("contain.text", "Must be after or equal Minimum Date");
  });
  it("Date time picker with maxDate after minDate should not show a validation error", () => {
    ...
    cy.get(".invalid-feedback > div").should("be.not.exist");
  });
  it("Date type", () => {
    cy.get("[data-cy=controls-FormDatePicker]").drag("[data-cy=screen-drop-zone]", { position: "bottom" });
    cy.get("[data-cy=screen-element-container]").click();
  ...
  it("Date Time Picker should have the class .datePicker applied in design mode", () => {
    cy.get("[data-cy=controls-FormDatePicker]").drag("[data-cy=screen-drop-zone]", { position: "bottom" });
    cy.get("[data-cy=screen-element-container] .vdpComponent").should("have.class", "datePicker");
  });

  it("Date Time Picker should have the class .datePicker applied in preview mode", () => {
    cy.get("[data-cy=controls-FormDatePicker]").drag("[data-cy=screen-drop-zone]", { position: "bottom" });
    cy.get("[data-cy=mode-preview]").click();
    cy.get("[data-cy=preview-content] .vdpComponent").should("have.class", "datePicker");
  });
});
