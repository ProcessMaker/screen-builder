import Tooltip from "./components/inspector/tooltip.vue";
import DeviceVisibility from "./components/inspector/device-visibility.vue";
...
export const javascriptReservedKeywords =
  "null,break,case,catch,continue,debugger,default,delete,do,else,finally,for,function,if,in,instanceof,new,return,switch,this,throw,try,typeof,var,void,while,with,class,const,enum,export,extends,import,super,true,false";
...
export const defaultValueProperty = {
  ...
  config: {
    label: "Default Value",
    helper:
      "The default value is pre populated using the existing request data. This feature will allow you to modify the value displayed on screen load if needed."
  }
};
