    ...
    <div class="d-flex h-100 mb-5">
      <div class="w-25 border overflow-auto">
        ...
        <div class="card-body d-flex flex-wrap mb-5">
          ...
          >
            <div
              class="d-flex align-content-center flex-wrap p-2"
      ...
      <div class="card w-25 border d-flex flex-column">
      ...
      <b-modal id="addPageModal" @ok="addPage" title="Add New Page">
        <form-input
          v-model="addPageName"
          label="Page Name"
          helper="The name of the new page to add"
        ></form-input>
      </b-modal>
...
$inspectorTopPosition: -10rem;
$inspectorLeftPosition: 0;
$inspectorFooterBottomPosition: 3.2rem;
$inspectorErrorDrawerHeight: 10rem;
$inspectorPanelBackgroundColor: #fff;
$border-color: #dee2e6;
...
.inspector-footer {
    background-color: $inspectorPanelBackgroundColor;
    bottom: $inspectorFooterBottomPosition;
}

.inspector-footer__error {
    background: $inspectorPanelBackgroundColor;
    position: absolute;
