import SelectDataTypeMask from "./components/inspector/select-data-type-mask.vue";
...
function dataTypeFactory(options) {
  return {
    ...
    config: {
      ...
      name: "Data Type",
      helper:
        "The data type specifies what kind of data is stored in the variable.",
      validation: "required",
      options
    }
  };
...
export const DataTypeWithoutDateProperty = dataTypeFactory(
  allOptionsWithoutDate
);
